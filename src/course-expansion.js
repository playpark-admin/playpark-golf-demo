...
const profiles=[
 ...
 {id:'valley',name:'산들 계곡',english:'ROLLING VALLEY',letter:'H',tag:'골짜기를 읽는 재미',level:3,unlockLevel:3,description:'오르내리는 골짜기와 연속 굽이',color:'#756049',light:'#ece4cc',accent:'#a7b866',width:10,bend:12,swing:12,rise:2.8,grade:.03,lengths:[50,78,55,82,120,45,86,52,80],style:'valley'},
 ...
 {id:'ridge',name:'하늘 능선',english:'SKY RIDGE',letter:'J',tag:'좁은 능선의 긴장감',level:3,unlockLevel:4,description:'긴 코스와 횡경사, 한 샷씩 신중하게',color:'#606b9b',light:'#e1e5f2',accent:'#91ad63',width:9.5,bend:13,swing:13,rise:3,grade:.04,lengths:[54,85,58,90,125,48,92,56,88],style:'ridge'}
];
