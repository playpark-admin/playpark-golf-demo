...
function pause(){if(state.moving)return;modal(`<span class="eyebrow">TAKE A LITTLE BREAK</span><h2 id="modal-title" data-music-pause>잠깐, 쉬어가도 괜찮아요</h2><p>현재 위치와 타수는 자동으로 저장되어 있어요.</p><button class="primary full" data-action="close">라운드 계속하기 ${icon('play',17)}</button>${musicButton()}<button class="secondary full" data-action="lobby">저장하고 로비로</button>`);}
